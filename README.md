...
### 🎮 [Game Arcade](https://github.com/subam-shrestha/python-learning-projects/blob/main/game_arcade.py)
...
### 📊 [Calculator Suite](https://github.com/subam-shrestha/python-learning-projects/blob/main/calculator.py)
Basic arithmetic calculator with error handling
- **Tech:** Python
- **Skills:** Functions, exception handling, user interaction

### 🔮 [Fortune Teller](https://github.com/subam-shrestha/python-learning-projects/blob/main/fortune_teller.py)
